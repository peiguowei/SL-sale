		...
		<li><a href="/backend/modifygoodspack.html">修改商品套餐</a></li>
			...
			<legend>修改商品套餐</legend>
                 <form action="/backend/savemodifygoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsPackFunc();">
					  ...
					  <label class="control-label" for="m_goodsPackName">套餐名称: </label>
					  <div class="controls">
					  ...
					  <div class="control-group">
					  <label class="control-label" for="m_goodsPackCode">套餐编号: </label>
					  <div class="controls">
					...
					<div class="control-group">
					  <label class="control-label" for="m_typeId">套餐类型: </label>
					  <div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="m_num">库存量：</label>
						<div class="controls">
					...
					<div class="control-group">
					  <label class="control-label" for="m_totalPrice">套餐总价: </label>
					  <div class="controls">
					...
					<div class="control-group">
					  <label class="control-label" for="m_note">套餐说明:</label>
					  <div class="controls">
