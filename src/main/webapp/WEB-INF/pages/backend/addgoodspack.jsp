		...
		<li><a href="/backend/addgoodspack.html">添加商品套餐</a></li>
			...
			<legend>添加商品套餐</legend>
                 <form action="/backend/saveaddgoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return addGoodsPackFunc();">
					  ...
					  <label class="control-label" for="a_goodsPackName">套餐名称: </label>
					  <div class="controls">
					  ...
					  <div class="control-group">
					  <label class="control-label" for="a_goodsPackCode">套餐编号: </label>
					  <div class="controls">
					...
					<div class="control-group">
					  <label class="control-label" for="a_typeId">套餐类型: </label>
					  <div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="a_num">库存量：</label>
						<div class="controls">
					...
					<div class="control-group">
					  <label class="control-label" for="a_totalPrice">套餐总价: </label>
					  <div class="controls">
					...
					<div class="control-group">
					  <label class="control-label" for="a_note">套餐说明:</label>
					  <div class="controls">
