		...
		<form action="/informanage/addAffiche.html" enctype="multipart/form-data" method="post" onsubmit="return addAfficheFunction();">
			...
			<div class="add_affiche_modal-body">
				...
				<ul class="downul">
					<li>
					<label>有效期：</label> 
						<input type="text" name="startTime" value="2012-05-15" id="startTime"/>
						<input type="text" name="endTime" value="2012-05-16" id="endTime"/>
					</li>
				</ul>
				<ul class="downul">
					<li>
		...
		<form action="/informanage/modifyAffiche.html" enctype="multipart/form-data" method="post" onsubmit="return modifyAfficheFunction();">
			...
			<div class="add_affiche_modal-body">
				...
				<ul class="downul">
					<li>
					<label>有效期：</label> 
						<input type="text" name="startTime" value="2012-05-15" id="startTimeModify"/>
						<input type="text" name="endTime" value="2012-05-16" id="endTimeModify"/>
					 </li>
				</ul>
				<ul class="downul">
...
<script>
	$(function () {
		$("#startTimeModify").datetimepicker({
            format: 'yyyy-mm-dd',
			minView: 'month'
        });
		$("#endTimeModify").datetimepicker({
            format: 'yyyy-mm-dd',
			minView: 'month'
        });
